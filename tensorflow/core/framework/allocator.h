...
class Allocator {
 ...
 //*fareed
  ...
  string op_name_;
  static std::map<std::string, int64> mp;
  static std::map<std::string, int> allocated_deallocated_times; 
  string get_op_name(){return op_name_;}
  virtual void set_op_name(string op_name){op_name_ = op_name;}
  //*end fareed
